...
dnf install nss-tools jq xsel > /dev/null 2>&1
...
# fi
dnf install php-{cli,process,mbstring,mcrypt,xml}

$VERSION='7.0'
# Install PHP $VERSION
dnf install -y "php$VERSION-cli php$VERSION-common php$VERSION-curl php$VERSION-json php$VERSION-mbstring php$VERSION-mcrypt php$VERSION-mysql php$VERSION-opcache php$VERSION-readline php$VERSION-xml php$VERSION-zip"
